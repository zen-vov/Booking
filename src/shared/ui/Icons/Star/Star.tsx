export default function Star() {
  return (
    ...
    >
      <rect width="33" height="33" fill="url(#pattern0_127_59)" />
      <defs>
        <pattern
          id="pattern0_127_59"
