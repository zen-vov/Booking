export default function Instagram() {
  return (
    ...
    >
      <rect width="51" height="51" fill="url(#pattern0_1_37)" />
      <defs>
        <pattern
          id="pattern0_1_37"
