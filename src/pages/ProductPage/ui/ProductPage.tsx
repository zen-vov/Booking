  ...
  return (
    <section className="py-[75px]">
      <div className="flex justify-between items-center mb-6">
        ...
        <h3 className="text-xl">320 000 т/мес.</h3>
      </div>
        ...
        <div>
            ...
            <div className="">
              <div className="flex gap-[10px]">
                <div className="flex flex-col gap-[0.7rem]">
                  ...
                  <span className="text-[16px]">4 из 15</span>
                  <span className="text-[16px]">свободная планировка</span>
                  <span className="text-[16px]">127,5 м²</span>
                </div>
              </div>
            </div>
          </div>
          <div className="">
            ...
            <p className="text-[14px]">
              Прекрасная квартира на 12-м этаже Комфорт Класса. Рядом Мега,
              магнум, кафе, рестораны, спа центры, ботанический сад, выставочный
              центр Атакент, торговый центр Адк Москва, В 10 минутах езды
              Президентский паРК. Всё рядом. При входе в квартиру вы встретите
              прихожую с зеРКалом в полный рост, а далее просторную гостиную,
              где установлен удобный диван и телевизор с функцией Smart TV.
              Современная кухня оборудована всем необходимым для приготовления
              пищи. Здесь вы найдете варочную плиту, духовой шкаф, холодильник,
              микроволновую печь и электрический чайник. В кухне также
              предоставлена посуда, чтобы вы могли готовить свои любимые блюда.
              В спальне вас ждет большая двуспальная кровать с ортопедическим
              матрасом, обеспечивающим вашему сну максимальный комфорт. В ванной
              комнате установлена стиральная машина и душевая кабина. Для вашего
              удобства предоставлены зубные наборы, шампунь, кремы и даже
              уходовая маска для лица, и другие средства гигиены.
            </p>
          </div>
          <div className="">
            ...
            <div className="flex gap-[489px]">
              ...
              <div>
                <ul className="flex flex-col gap-2.5">
                  <li className="text-[15px]">Есть</li>
                  <li className="text-[15px]">Есть</li>
                  <li className="text-[15px]">Есть</li>
                  <li className="text-[15px]">Есть</li>
                  <li className="text-[15px]">Есть</li>
