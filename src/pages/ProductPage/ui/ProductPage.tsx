            ...
            <div className="w-[110%] h-[376px]">
              <div className="flex flex-col gap-[22px] mb-12">
                ...
                <div className="flex gap-4">
                  <div
                    style={{
                      backgroundImage: `url(${advertisement.advertisement_images[0]})`,
                    }}
            ...
            <div>
              ...
              <div className="flex flex-col mt-10">
                ...
                <p className="text-[14px] mt-3">
                  Учусь в 4 курсе. В университете SDU University. Ищем 2 девушек
                  на подселение. Без вредных привычек, чистоплотная,
                  ответственная.
                </p>
              </div>
              <div className="mt-10">
